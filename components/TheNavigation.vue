  ...
  <nav :class="navClass" class="navigation-drawer" aria-label="Main menu" :style="navStyle">
    <div class="sitenav">
      ...
      <ul>
        ...
        <li>
          <NuxtLinkLocale :tabIndex=" tabIndex" @click="navState = 'close'" to="/services">{{ w.nav_page_services
            }}</NuxtLinkLocale>
        </li>
        <li>
        ...
        <li>
          <NuxtLinkLocale :tabIndex="tabIndex" @click="navState = 'close'" to="/wissen">{{ w.nav_page_wissen
            }}</NuxtLinkLocale>
        </li>
        <li>
